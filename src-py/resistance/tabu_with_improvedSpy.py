...
class AIAgent(Agent):
    ...
    def propose_mission(self, team_size, betrayals_required=1):
        ...
        '''
        self.betray_required = betrayals_required
        team = []
    ...
    def vote_outcome(self, mission, proposer, votes):
        ...
        '''
        if self.number_of_players/2 > len(votes):  # the vote result is false
    ...
    def betray(self, mission, proposer):
        ...
        if spy_num > self.betray_required:
            betray_rate = 0.5

        if proposer not in self.spy_list:
            betray_rate = 1
        ...
        if self.is_spy() != True and betrayals != 0:
            for opponent in mission:
                ...
                if opponent != self.player_number and self.round == 0:
                    self.watch_list[opponent] += 0.2
        # the resistance agent will have bigger chance to get the leader, therefore facing a failed result
        # given a lower chance to penalize the proposer
